                    ...
                    <div class="column is-flex">
                        <div class="column-child terminal shadow">
                            <div class="terminal-bar dark-mode">
                                ...
                                <div class="terminal-bar-text is-hidden-mobile dark-mode-text">root@fs6ah:~#</div>
                            </div>
                            <div class="terminal-window" onclick="document.getElementById('dummyKeyboard').focus();">
                                <div class="terminal-output" id="terminalOutput">
                                    <div class="terminal-line">
                                        <span class="help-msg">./FS6 Tools Panel  <span class="code"></span></span>
                                    </div>
                                </div>
                                <div class="terminal-line">
                                    
                                <span class="success">➜</span> <span class="directory">┌─[root@fs6ah]─[~]
                                    <br>
                                    <span class="success">➜</span> <span class="directory">└──╼ #

                                        
                                    </span> <span class="user-input" id="userInput"></span>
